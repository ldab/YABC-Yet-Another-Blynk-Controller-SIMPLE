...
String WiFiManager::htmlemail(String AlarmMessage){
    ...
    htmlBody += "</strong><p><span style=\"font-size: 12px;\">Give us a Github â­:&nbsp;<a href=\"https://github.com/ldab\" target=\"_blank\" rel=\"noopener\">https://github.com/ldab</a>&nbsp;ðŸ˜‰</p></p></td></tr></tbody></table>";
  return htmlBody;
}
